(function(g){var window=this;var Cua=function(a,b){var c=[];g.Nf(b,function(a){var b;try{b=g.gj.prototype.o.call(this,a,!0)}catch(f){if("Storage: Invalid value was encountered"==f)return;throw f;}g.p(b)?g.fj(b)&&c.push(a):c.push(a)},a);
return c},Dua=function(a,b){var c=Cua(a,b);
(0,g.G)(c,function(a){g.gj.prototype.remove.call(this,a)},a)},Eua=function(a){return a.H?a.F+((0,g.F)()-a.A)/1E3:a.F},Fua=function(){var a=g.hj;
Dua(a,a.g.Hd(!0))},v9=function(a){g.Iw.call(this,"ScreenServiceProxy");
this.Sc=a;this.o=[];this.o.push(this.Sc.$_s("screenChange",(0,g.z)(this.rO,this)));this.o.push(this.Sc.$_s("onlineScreenChange",(0,g.z)(this.PK,this)))},w9=function(a){g.Ew("cloudview",a)},Gua=function(a){w9("setApiReady_ "+a);
g.oa("yt.mdx.remote.cloudview.apiReady_",a,void 0)},x9=function(){return g.u("yt.mdx.remote.cloudview.instance_")},Hua=function(a){g.Li[a]&&(a=g.Li[a],(0,g.G)(a,function(a){g.Ji[a]&&delete g.Ji[a]}),a.length=0)},y9=function(){return g.u("yt.mdx.remote.connection_")},z9=function(a){g.oa("yt.mdx.remote.connectData_",a,void 0)},Iua=function(a){g.oa("yt.mdx.remote.currentScreenId_",a,void 0)},A9=function(){return g.u("yt.mdx.remote.currentScreenId_")},C9=function(){if(!B9){var a=g.u("yt.mdx.remote.screenService_");
...
g.jj("yt-remote-cast-installed",a)},G9=function(a){g.Ew("cloudview",a)},Jua=function(a,b){x9().init(a,b)},H9=function(){return!!g.kj("yt-remote-cast-installed")},Kua=function(){w9("dispose");
var a=x9();a&&a.dispose();g.oa("yt.mdx.remote.cloudview.instance_",null,void 0);Gua(!1);g.Ni(I9);I9.length=0},Lua=function(){var a=window.document.createElement("a");
g.Ae(a,"https://www.gstatic.com/cv/js/sender/v1/cast_sender.js");a=a.href.replace(/^[a-zA-Z]+:\/\//,"//");return"js-"+g.Ta(a)},Mua=function(a,b){var c=window.document.createElement("script");
...
c.src="https://www.gstatic.com/cv/js/sender/v1/cast_sender.js";var d=window.document.getElementsByTagName("head")[0]||window.document.body;d.insertBefore(c,d.firstChild);return c},Nua=function(a){var b=g.Hi();
if(b)if(b.clear(a),a)Hua(a);else for(var c in g.Li)Hua(c)},J9=function(){return g.u("yt.mdx.remote.channelParams_")||{}},L9=function(a){var b=y9();
z9(null);a||Iua("");g.oa("yt.mdx.remote.connection_",a,void 0);K9&&((0,g.G)(K9,function(b){b(a)}),K9.length=0);
b&&!a?g.Qi("yt-remote-connection-change",!1):!b&&a&&g.Qi("yt-remote-connection-change",!0)},Oua=function(){return g.u("yt.mdx.remote.connectData_")},M9=function(){var a=A9();
if(!a)return null;var b=C9().Nd();return g.mi(b,a)},Pua=function(a,b){F9(!0);
D9(!1);Jua(a,function(a){a?(Gua(!0),g.Pi("yt-remote-cast2-api-ready")):(G9("Failed to initialize cast API."),F9(!1),g.lj("yt-remote-cast-available"),g.lj("yt-remote-cast-receiver"),Kua());b(a)})},Qua=function(){return H9()?x9()?x9().getCastSession():(G9("getCastSelector: Cast is not initialized."),null):(G9("getCastSelector: Cast API is not installed!"),null)},Rua=function(){if(g.xoa){var a=2,b=g.tw(),c=function(){a--;
0==a&&b&&b(!0)};
window.__onGCastApiAvailable=c;g.yw("//www.gstatic.com/cast/sdk/libs/sender/1.0/cast_framework.js",g.vw,c)}},Sua=function(){var a=Lua(),b=window.document.getElementById(a),c=b&&g.hh(b,"loaded");
c||b&&!c||(b=Mua(a,function(){g.hh(b,"loaded")||(g.ih(b,"loaded","true"),g.Pi(a),g.ti(g.za(Nua,a),0))}))},Tua=function(a){return(0,g.Q)(a,function(a){return{key:a.id,
name:a.name}})},O9=function(a,b){A9();
M9()&&M9();Iua(a.id);var c=new g.Uy(N9,a,J9());c.connect(b,Oua());c.subscribe("beforeDisconnect",function(a){g.Qi("yt-remote-before-disconnect",a)});
...
var a=y9();a&&(a.disconnect(1),L9(null))},Uua=function(){var a;
a=C9().Sc.$_gos();var b=M9();b&&y9()&&(g.li(a,b)||a.push(b));return Tua(a)},U9=function(a,b){g.cl.call(this);
this.g=0;this.B=a;this.D=[];this.C=new g.Jy;this.A=this.o=null;this.H=(0,g.z)(this.aJ,this);this.F=(0,g.z)(this.Xj,this);this.G=(0,g.z)(this.$I,this);this.J=(0,g.z)(this.nJ,this);var c=0;a?(c=a.getProxyState(),3!=c&&(a.subscribe("proxyStateChange",this.bs,this),Vua(this))):c=3;0!=c&&(b?this.bs(c):g.ti((0,g.z)(function(){this.bs(c)},this),0));
var d=Qua();d&&T9(this,d);this.subscribe("yt-remote-cast2-session-change",this.J)},V9=function(a){return new g.Oy(a.B.getPlayerContextData())},Wua=function(a,b,c,d,e){var f=V9(a),k=e||f.listId;
d=d||0;var l={videoId:b,currentIndex:d};g.Sy(f,b,d);g.p(c)&&(g.Qy(f,c),l.currentTime=c);g.p(k)&&(l.listId=k);W9(a,"setPlaylist",l);e||X9(a,f)},Vua=function(a){(0,g.G)("nowAutoplaying autoplayDismissed remotePlayerChange remoteQueueChange autoplayModeChange autoplayUpNext previousNextChange".split(" "),function(a){this.D.push(this.B.subscribe(a,g.za(this.hL,a),this))},a)},Xua=function(a){(0,g.G)(a.D,function(a){this.B.unsubscribeByKey(a)},a);
a.D.length=0},Y9=function(a,b){50>a.C.Bc()&&g.Ly(a.C,b)},Z9=function(a,b,c){var d=V9(a);
g.Qy(d,c);-1E3!=d.g&&(d.g=b);X9(a,d)},W9=function(a,b,c){a.B.sendMessage(b,c)},X9=function(a,b){Xua(a);
a.B.setPlayerContextData(g.Ty(b));Vua(a)},T9=function(a,b){a.A&&(a.A.removeUpdateListener(a.H),a.A.removeMediaListener(a.F),a.Xj(null));
a.A=b;a.A&&($9("Setting cast session: "+a.A.sessionId),a.A.addUpdateListener(a.H),a.A.addMediaListener(a.F),a.A.media.length&&a.Xj(a.A.media[0]))},Yua=function(a){var b=a.o.media,c=a.o.customData;
...
a.code!=window.chrome.cast.ErrorCode.TIMEOUT&&(this.Xb("Retrying "+b+" using MDx browser channel."),W9(this,b,c))},a)},Zua=function(a){var b=!1;
...
w9("cloudview.createSingleton_: "+b);return b},$ua=function(){var a=0<=g.ic.search(/\ (CrMo|Chrome|CriOS)\//);
return g.Bi||a},b$=function(a,b){E9()?x9().setConnectedScreenStatus(a,b):G9("setConnectedScreenStatus called before ready.")},ava=function(){w9("clearCurrentReceiver");
g.lj("yt-remote-cast-receiver")},bva=function(){if(0<=window.navigator.userAgent.indexOf("CriOS")){var a=window.__gCrWeb&&window.__gCrWeb.message&&window.__gCrWeb.message.invokeOnHost;
if(a){Rua();a({command:"cast.sender.init"});return}}if(window.chrome)if(Rua(),a=window.navigator.userAgent,0<=a.indexOf("Android")&&0<=a.indexOf("Chrome/")&&window.navigator.presentation){var a="",b=g.qw();55<=b?a="55":50<=b&&(a="50");g.yw("//www.gstatic.com/eureka/clank"+a+g.ww,g.vw)}else g.zw(0);else g.vw()},cva=function(a){a?(g.jj("yt-remote-session-app",a.app),g.jj("yt-remote-session-name",a.name)):(g.lj("yt-remote-session-app"),g.lj("yt-remote-session-name"));
g.oa("yt.mdx.remote.channelParams_",a,void 0)},dva=function(){var a=J9();
if(g.Vb(a)){var a=g.nj(),b=g.kj("yt-remote-session-name")||"",c=g.kj("yt-remote-session-app")||"",a={device:"REMOTE_CONTROL",id:a,name:b,app:c,"mdx-version":3};g.oa("yt.mdx.remote.channelParams_",a,void 0)}},eva=function(){var a=P9();
a?(Q9("Resume connection to: "+g.ii(a)),O9(a,0)):(g.xj(),ava(),Q9("Skipping connecting because no session screen found."))},fva=function(a){Q9("remote.onCastSessionChange_: "+g.ii(a));
if(a){var b=M9();b&&b.id==a.id?b$(b.id,"YouTube TV"):(b&&S9(),O9(a,1))}else y9()&&S9()},gva=function(){var a=Uua(),b=M9();
b||(b=P9());return g.ab(a,function(a){return b&&g.fi(b,a.key)?!0:!1})},hva=function(){var a=g.kj("yt-remote-cast-receiver");
return a?a.friendlyName:null},iva=function(a,b,c,d){$ua()?Zua(b)&&(D9(!0),window.chrome&&window.chrome.cast&&window.chrome.cast.isAvailable?Pua(a,c):(window.__onGCastApiAvailable=function(b,d){b?Pua(a,c):(G9("Failed to load cast API: "+d),F9(!1),D9(!1),g.lj("yt-remote-cast-available"),g.lj("yt-remote-cast-receiver"),Kua(),c(!1))},d?window.spf?window.spf.script.load("https://www.gstatic.com/cv/js/sender/v1/cast_sender.js","",void 0):Sua():bva())):w9("Cannot initialize because not running Chrome")},
jva=function(a){this.port=this.A="";
...
c.H=b||0;c.g.V("progresssync",b,d)},kva=function(a){d$(a,0);
...
c?Wua(a.g,g$(a),b,c.Ld(),c.listId.toString()):Wua(a.g,g$(a),b);e$(a,new g.Ol(1))},lva=function(a,b){if(b){var c=a.Z.Uc("captions","tracklist",{qw:1});
...
var c=a.D;if(b.o!=c.o||b.g!=c.g){var d=g.S(b,2);if(d!=g.S(a.D,2)){var e=a.Z;(e=g.pm(e.app,e.playerType||1))&&g.YU(e,d)}a.D=b;mva(a.H,c,b)}},j$=function(){var a=gva();
!a&&H9()&&hva()&&(a={key:"cast-selector-receiver",name:hva()});return a},nva=function(){var a=Uua();
H9()&&g.kj("yt-remote-cast-available")&&a.push({key:"cast-selector-receiver",name:"Cast..."});return a},ova=function(a){var b={device:"Desktop",
app:"youtube-desktop"};g.hj&&Fua();g.qj();N9||(N9=new jva,g.zj()&&(N9.g="/api/loungedev"));K9||(K9=g.u("yt.mdx.remote.deferredProxies_")||[],g.oa("yt.mdx.remote.deferredProxies_",K9,void 0));dva();var c=C9();if(!c){var d=new g.Vw(N9);g.oa("yt.mdx.remote.screenService_",d,void 0);c=C9();iva(a,d,function(a){a?A9()&&b$(A9(),"YouTube TV"):d.subscribe("onlineScreenChange",function(){g.Qi("yt-remote-receiver-availability-change")})},!(!b||!b.loadCastApiSetupScript))}b&&!g.u("yt.mdx.remote.initialized_")&&
...
g.Qi("yt-remote-auto-connect","cast-selector-receiver")})),k$.push(g.Mi("yt-remote-cast2-receiver-resumed",function(){g.Qi("yt-remote-receiver-resumed","cast-selector-receiver")})),k$.push(g.Mi("yt-remote-cast2-session-change",fva)),k$.push(g.Mi("yt-remote-connection-change",function(a){a?b$(A9(),"YouTube TV"):P9()||(b$(null,null),ava())})),a=J9(),b.isAuto&&(a.id+="#dial"),g.Fh("desktop_enable_autoplay")&&(a.capabilities=["atp"]),a.name=b.device,a.app=b.app,Q9(" -- with channel params: "+g.xf(a)),
cva(a),c.start(),A9()||eva())},l$=function(){H9()?x9()?E9()?(w9("Requesting cast selector."),x9().requestSession()):(w9("Wait for cast API to be ready to request the session."),I9.push(g.Mi("yt-remote-cast2-api-ready",l$))):G9("requestCastSelector: Cast is not initialized."):G9("requestCastSelector: Cast API is not installed!")},m$=function(a){g.qu.call(this,a);
this.A={key:g.ki(),name:g.P("YTP_MDX_MY_COMPUTER")};this.C=null;this.D=[];this.J=this.o=null;this.G=[this.A];this.B=this.A;this.F=new g.Ol(64);this.H=0},mva=function(a,b,c){a.F=c;
...
g.h.R=function(){Xua(this);this.B=null;this.C.clear();T9(this,null);U9.N.R.call(this)};
...
g.h.Xj=function(a){$9("Cast media: "+!!a);this.o&&this.o.removeUpdateListener(this.G);if(this.o=a)this.o.addUpdateListener(this.G),Yua(this),this.V("remotePlayerChange")};
g.h.$I=function(a){a?(Yua(this),this.V("remotePlayerChange")):this.Xj(null)};
g.h.nJ=function(){var a=Qua();a&&T9(this,a)};
g.h.Xb=function(a){g.Ew("CP",a)};
var k$=[];g.h=jva.prototype;g.h.rh=function(a,b,c){var d=this.g;if(g.p(c)?c:this.o)d="https://"+this.A+this.port+this.g;return g.gg(d+a,b||{})};
...
g.h.Ox=function(){g.Vb(this.B)||lva(this,this.B);this.C=!1};
...
new g.Ol(128,a))}var a=V9(this.g).o,b=this.B;(a||b?a&&b&&a.trackName==b.trackName&&a.languageCode==b.languageCode&&a.languageName==b.languageName&&a.format==b.format&&a.kind==b.kind:1)||(this.B=a,lva(this,a));a=V9(this.g);-1==a.volume||Math.round(this.Z.getVolume())==a.volume&&this.Z.Vd()==a.muted||this.G.isActive()||this.Kz()}else kva(this)};
g.h.Yx=function(){this.Z.V("mdxpreviousnextchange")};
g.h.$j=function(){f$(this)||kva(this)};
...
g.A(m$,g.qu);g.h=m$.prototype;g.h.create=function(){ova("embedded"==g.U(this.g).g);this.D.push(g.Mi("yt-remote-before-disconnect",this.XI,this));this.D.push(g.Mi("yt-remote-connection-change",this.qL,this));this.D.push(g.Mi("yt-remote-receiver-availability-change",this.Zx,this));this.D.push(g.Mi("yt-remote-auto-connect",this.oL,this));this.D.push(g.Mi("yt-remote-receiver-resumed",this.nL,this));this.Zx()};
g.h.load=function(){this.g.To();m$.N.load.call(this);this.C=new c$(this,this.g,this.o);var a;a=(a=Oua())?a.currentTime:0;var b=R9()?new U9(y9(),void 0):null;0==a&&b&&(a=g.Ry(V9(b)));0!=a&&(this.H=a||0,this.g.V("progresssync",a,void 0));mva(this,this.F,this.F);g.B2(this.g.app,6)};
g.h.unload=function(){this.g.V("mdxautoplaycanceled");this.B=this.A;g.Hb(this.C,this.o);this.o=this.C=null;m$.N.unload.call(this);g.B2(this.g.app,5)};
...
g.h.TP=function(){var a=V9(this.o),b=this.g.getVideoData(),c=this.g.zh(),d=b.clipEnd,b=b.clipStart,e=this.getCurrentTime(),f=a.getDuration(),k;k=a.H?a.B+((0,g.F)()-a.A)/1E3:a.B;var l=1>=Eua(a)-this.getCurrentTime(),m=a.J,n=Eua(a),a=0<a.C?a.C+((0,g.F)()-a.A)/1E3:a.C;return{allowSeeking:c,clipEnd:d,clipStart:b,current:e,displayedStart:-1,duration:f,ingestionTime:k,isPeggedToLive:l,loaded:m,seekableEnd:n,seekableStart:a}};
...
g.h.Zx=function(){this.G=[this.A].concat(nva());var a=j$()||this.A;n$(this,a);this.g.wa("onMdxReceiversChange")};
